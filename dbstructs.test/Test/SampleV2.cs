...
namespace dbstructs.test
{
	...
	public static partial class SampleV2
	{
		...
		/// <summary>Gets a new <see cref="Cave.Data.ITable{TKey, TStruct}"/> (long, DefaultSampleRow) instance for accessing the <c>sample</c> table.</summary>
		public static Cave.Data.ITable<long, DefaultSampleRow> Sample => new Cave.Data.Table<long, DefaultSampleRow>(GetTable("sample"));
	}
}
