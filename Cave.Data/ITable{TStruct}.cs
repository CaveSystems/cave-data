    ...
    where TStruct : struct
{
    ...
    /// <summary>
    /// Gets the row struct with the given index. This allows a memorytable to be used as virtual list for listviews, ... Note that indices will change on each
    /// update, insert, delete and sorting is not garanteed!.
    /// </summary>
