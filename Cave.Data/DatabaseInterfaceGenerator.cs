...
namespace Cave.Data
{
    ...
    public class DatabaseInterfaceGenerator
    {
        ...
        /// <summary>
        /// Naming strategy for classes, properties, structures and fields.
        /// </summary>
        ...
        public GenerateTableCodeResult GenerateTableStructFile(ITable table, string databaseName = null, string tableName = null, string className = null, string structFile = null, string getterName = null)
        {
        ...
        public string Generate()
        {
            ...
            foreach (var table in tables)
            {
                result.AppendLine();
                result.AppendLine(
                    $"\t\t/// <summary>Gets a new ITable<{table.ClassName}> instance for accessing the <c>{table.TableName}</c> table.</summary>");
                result.AppendLine(
                    $"\t\tpublic static ITable<{table.ClassName}> {table.GetterName} => new Table<{table.ClassName}>(database[\"{table.TableName}\"]);");
            }
