    ...
    public class DatabaseInterfaceGenerator
    {
        ...
        public string Generate()
        {
            ...
            foreach (var table in tables)
            {
                result.AppendLine();
                result.AppendLine(
                    $"\t\t/// <summary>Gets a new <see cref=\"ITable{{table.ClassName}}\"/> instance for accessing the <c>{table.TableName}</c> table.</summary>");
                result.AppendLine(
            ...
            string structFile = null, string getterName = null)
        {
            ...
            var result = table.GenerateStructFile(databaseName ?? table.Database.Name, tableName ?? table.Name, className, structFile, NameSpace,
                NamingStrategy);
