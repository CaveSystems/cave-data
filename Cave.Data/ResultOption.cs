...
public sealed class ResultOption : IEnumerable<ResultOption>, IEquatable<ResultOption>
{
            ...
            foreach (var option in this)
            {
                switch (option.Mode)
                {
                    ...
                    case ResultOptionMode.Group:
                        if (option.Parameter is null) throw new InvalidOperationException("Fieldname is null!");
    ...
    public static bool operator ==(ResultOption left, ResultOption right)
    {
        ...
        return left is not null && (left.Mode == right.Mode) && (left.Parameter == right.Parameter);
    }
    ...
    /// <inheritdoc/>
    public override bool Equals(object? obj) => obj is ResultOption resultOption && Equals(resultOption);

    /// <inheritdoc/>
    public bool Equals(ResultOption? other) => other is not null && (other.Mode == Mode) && (other.Parameter == Parameter);
