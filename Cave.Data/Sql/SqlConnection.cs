...
/// <summary>
/// Wraps an <see cref="IDbConnection"/> and allows always to obtain the database name of the connection. This is needed for connection reusing at <see cref="SqlStorage"/>.
/// </summary>
