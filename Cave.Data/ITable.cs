...
public interface ITable
{
    ...
    long Count(Search? search = null, ResultOption? resultOption = null);
    ...
    Row GetRow(Search? search = null, ResultOption? resultOption = null);
    ...
    IList<Row> GetRows(Search? search = null, ResultOption? resultOption = null);

    /// <summary>Obtains all different fieldName values of a given fieldName.</summary>
    /// <typeparam name="TValue">The returned value type.</typeparam>
    /// <param name="fieldName">The fieldName.</param>
    /// <param name="search">The search.</param>
    /// <returns>A new <see cref="IList{TValue}"/>.</returns>
    IList<TValue> GetValues<TValue>(string fieldName, Search? search)
    ...
    /// <param name="resultOption">Options for the search and the result set.</param>
    /// <returns>A new <see cref="IList{TValue}"/>.</returns>
    IList<TValue> GetValues<TValue>(string fieldName, Search? search = null, ResultOption? resultOption = null)
        where TValue : IComparable<TValue>;
