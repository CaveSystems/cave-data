...
public static class IDatabaseExtensions
{
    ...
    public static ITable<TStruct> CreateTable<TStruct>(this IDatabase database, string? tableName = null, TableFlags flags = default, params string[] excludedFields)
    ...
    public static ITable<TKey, TStruct> CreateTable<TKey, TStruct>(this IDatabase database, string? tableName = null, TableFlags flags = default, params string[] excludedFields)
    ...
    public static DatabaseInterfaceGenerator GenerateInterface(this IDatabase database, string? className = null, string? nameSpace = null) =>
        new(database, className, nameSpace);
    ...
    public static ITable<TStruct> GetTable<TStruct>(this IDatabase database, string? tableName = null, TableFlags flags = default, params string[] excludedFields)
        where TStruct : struct
    {
        if (database == null)
        {
    ...
    /// <param name="flags">Flags for table loading.</param>
    /// <param name="excludedFields">Fields at <typeparamref name="TStruct"/> to be excluded.</param>
    public static void GetTable<TStruct>(this IDatabase database, out ITable<TStruct> table, TableFlags flags = default, params string[] excludedFields)
        where TStruct : struct
    {
    ...
    public static ITable<TKey, TStruct> GetTable<TKey, TStruct>(this IDatabase database, string? tableName = null, TableFlags flags = default, params string[] excludedFields)
        where TKey : IComparable<TKey>
        where TStruct : struct
    {
        if (database == null)
    ...
    /// <param name="flags">Flags for table loading.</param>
    /// <param name="excludedFields">Fields at <typeparamref name="TStruct"/> to be excluded.</param>
    public static void GetTable<TKey, TStruct>(this IDatabase database, out ITable<TKey, TStruct> table, TableFlags flags = default, params string[] excludedFields)
        where TKey : IComparable<TKey>
        where TStruct : struct
    {
        if (database == null) throw new ArgumentNullException(nameof(database));
    ...
    /// <typeparam name="TStruct">Row structure.</typeparam>
    public static IDictionary<TKey, TStruct> ReadTable<TKey, TStruct>(this IDatabase database, string? tableName = null, TableFlags flags = default, params string[] excludedFields)
        where TKey : IComparable<TKey>
        where TStruct : struct
    {
        if (database == null)
